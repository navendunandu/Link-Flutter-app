...
class BuildingPermit extends StatefulWidget {
  const BuildingPermit({Key? key}) : super(key: key);

  @override
  State<BuildingPermit> createState() => _BuildingPermitState();
}

class _BuildingPermitState extends State<BuildingPermit> {
