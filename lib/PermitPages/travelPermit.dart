...
class TravelPermit extends StatefulWidget {
  const TravelPermit({Key? key}) : super(key: key);

  @override
  State<TravelPermit> createState() => _TravelPermitState();
}

class _TravelPermitState extends State<TravelPermit> {
                        ...
                        GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Travel starting dayte',
                              ),
                              validator: (value) {
                                if (_start == null) {
